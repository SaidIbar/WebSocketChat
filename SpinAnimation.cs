...
namespace WebSocketChat
{
    ...
    public static class SpinAnimation
    {
        ...
        private static int spinWait = 45;
        ...
        /// <summary>
        /// Start the animation at the end of a message
        /// </summary>
        /// <param name="message">The message to display before the spinner</param>
        /// <param name="spinWait">Wait time between spin steps in milliseconds</param>
        public static void Start(string message, int spinWait)
        {
            ...
            // Display the message and set spinner position right after it
        ...
        /// <summary>
        /// Stop the spin animation and clear the spinner character
        /// </summary>
        public static void Stop()
        {
            ...
            // Reset the cursor position and clear the spinner character
            Console.CursorLeft = spinnerPosition;
            //Console.Write(' ');
            Console.CursorLeft = spinnerPosition;
        ...
        /// <summary>
        /// Stop the spin animation and replace with a completion message
        /// </summary>
        /// <param name="completionMessage">Message to display after stopping the spinner</param>
        public static void Stop(string completionMessage)
        {
            // Stop the animation
            spinner.CancelAsync();
            ...
            // Reset the cursor position and write completion message
            Console.CursorLeft = spinnerPosition;
